...
sudo docker run --net=tmm-net --name=gfs.tmm.db -v $PWD/db/:/data/db -d mongo
sudo docker run --net=tmm-net --name=gfs.tmm.web -v $PWD/dev/:/source -p 0.0.0.0:8888:8888 -d bonas-web:0.0.1
